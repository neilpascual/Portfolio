export const projects = [
  ...
  // },
    ...
    {
    title: "IBentur",
    desc: 'Bentur one-stop mobile application designed for aspiring entrepreneurs, simplifying the journey from idea to successful business.',
    tags: ['Flutter','Dart','Firebase','AI model',],
    // live: 'https://fullsuite.tseksuite.com/auth/login',
    img: '/projects/ibentur.jpg',
    code: 'https://drive.google.com/drive/folders/1MfHXsOYIcPoJWJc-8WmO2QgFgJsNPs5j?fbclid=IwY2xjawPEm1BleHRuA2FlbQIxMQBzcnRjBmFwcF9pZAEwAAEeqkzadxC8GdkeG_5Vxm65Zd68rFFmwGtD09Td0UKpXmsLpRdbYlfak1JvAhs_aem_4VZN2vn7GhooV9MOScQJcw',
    category: 'mobile'
  },
       {
    title: "BalungGo",
